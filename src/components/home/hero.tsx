    ...
    <section className="flex min-h-screen items-center justify-center px-6 pt-8 pb-16 text-center sm:px-10 lg:px-16 lg:pt-10 lg:pb-24">
      <div>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="#projects"
            className="group flex items-center justify-center rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-50 via-gray-50 to-gray-200 px-5 py-2 text-lg font-medium text-gray-950 hover:bg-gradient-to-b hover:from-gray-100 hover:via-gray-100 hover:to-gray-100 active:shadow-inner"
          >
            <span className="block group-active:[transform:translate3d(0,1px,0)]">
              See Projects
            </span>
