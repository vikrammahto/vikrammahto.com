...
export function Services() {
  return (
    <section id="what-i-do" className="px-6 py-16 sm:px-10 lg:px-16 lg:py-24">
      ...
      <p className="mx-auto max-w-xl text-center text-zinc-600">
        Whether you need a full design and build, a quick audit, or just want to
        fix that AI-generated mess – I’ve got you covered.
      </p>
